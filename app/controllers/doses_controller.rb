class DosesController < ApplicationController
  ...
  def update
    if @dose.update(dose_params)
      redirect_to cocktail_path(@dose), notice: 'Dose was successfully updated.'
    else
      render :edit
    end
  end
  ...
  private
    ...
    def dose_params
      params.require(:dose).permit(:description, :cocktail_id, :ingredient_id, :cocktail, :ingredient)
    end
end
